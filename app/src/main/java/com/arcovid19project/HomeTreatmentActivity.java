...
import com.arcovid19project.Adapter.ImageSliderAdapter;
import com.arcovid19project.Adapter.LinkAdapter;
import com.arcovid19project.Models.Image_Slider;
import com.arcovid19project.Models.Link;
...
public class HomeTreatmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageSliderAdapter = new ImageSliderAdapter(HomeTreatmentActivity.this, image_sliders);
        sliderView.setSliderAdapter(imageSliderAdapter);

        linkAdapter = new LinkAdapter(HomeTreatmentActivity.this, links);
        ...
        Call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setData(Uri.parse("tel:+91-360-2292774"));
